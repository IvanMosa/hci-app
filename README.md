...
- Link to your production version: [**Production Version**](https://freelancia.up.railway.app/)
...
- Link to Assignment 3 - deploying application: [**Next.js - Deploying application**](https://freelancia.up.railway.app/)
