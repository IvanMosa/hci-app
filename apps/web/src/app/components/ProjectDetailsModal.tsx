            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-3 mb-2">
              ...
              <div className="hidden md:block relative group flex-shrink-0">
                ...
                {isLoggedIn && !isFreelancer && !hasExistingApplication && (
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-30">
